...
extern uintptr_t gofwatcher_beginWatch(char* path, OnFileChangedCallback fileChangeCallback, char* fileRegex);
extern void gofwatcher_stopWatch(uintptr_t contextHandle);
